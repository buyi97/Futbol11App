/**
 * Código fuente actualizado de apps-script/Code.gs
 * Listo para ser copiado al portapapeles desde la interfaz de usuario.
 */
 ...
 * Quién tiene acceso: "Cualquier usuario" (permite requests desde la web)
 *
